    ...
    <>
      <div className="row mb-3">
        <div className="col-12 text-right">
          <Link href={`/events/${event_id}/event_activities/add`} className="btn btn-primary">
            ...
            <div className="card-body">
              <DataTable
                ...
                actionColumnFn={(rowData) => (
                  <>
                    <Link href={`/events/${event_id}/event_activities/edit/${rowData.event_activity_id}`} className="text-primary">
                      <AppIcon ic="pencil" />
                    </Link>
                    &nbsp;|&nbsp;
