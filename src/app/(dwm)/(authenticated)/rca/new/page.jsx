    ...
    async function checkRcaSetting() {
        try {
            const res = await HttpClient({
                url: "/rca/rca-id-status",
                method: "GET"
            });

            if (res.success && !res.data.isAutoGenerated) {
                setRcaIdWarning("RCA ID is not configured. Please configure it in Settings page.");
            }
        } catch (err) {
            console.error("RCA Setting Check Error:", err);
        }
    }
            ...
            <div className="row">
                <div className="col-12">
                    <form className="p-3" onSubmit={handleSubmit}>
                        {!isEditMode && rcaIdWarning && (
                            <div className="alert alert-warning" >
                                <AppIcon ic="information-outline" /> 
                                <strong>RCA ID Setting Missing:</strong> {rcaIdWarning}
                            </div>
                         )}
