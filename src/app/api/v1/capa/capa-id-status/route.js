...
/**
 * Checks the settings table to see if the CAPA ID auto-generation is configured.
...
export async function GET(req) {
    try {
        ...
        const settingResults = await DB_Fetch(sql`
            ...
            WHERE setting_group = 'general' AND field_name = 'capa_id'
        `);
        ...
        return JsonResponse.success(
            ...
            "CAPA ID setting status retrieved successfully."
        );

    } catch (error) {
        console.error("[api/settings/capa-id-status] Error:", error);
