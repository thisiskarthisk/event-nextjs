...
/**
 * Checks the settings table to see if the RCA ID auto-generation is configured.
...
export async function GET(req) {
    try {
        ...
        const settingResults = await DB_Fetch(sql`
            ...
            WHERE setting_group = 'general' AND field_name = 'rca_id'
        `);
        ...
        return JsonResponse.success(
            ...
            "RCA ID setting status retrieved successfully."
        );

    } catch (error) {
        console.error("[api/settings/rca-id-status] Error:", error);
